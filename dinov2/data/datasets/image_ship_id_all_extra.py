...
class ImageShipID_All_Extra(ExtendedVisionDataset):
    ...
    def __init__(
        self,
        *,
        split: "ImageShipID_All_Extra.Split",
        root: str,
        extra: str,
    ...
    @property
    def split(self) -> "ImageShipID_All_Extra.Split":
        return self._split
    ...
    def _dump_entries(self) -> None:
        split = self.split
        if split == ImageShipID_All_Extra.Split.TEST:
            dataset = None
